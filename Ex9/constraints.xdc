...
create_generated_clock -name sys_clk -period 10.0 [get_ports clk]
...
set_property PACKAGE_PIN BB21 [get_ports {led[1]}]
set_property PACKAGE_PIN BA20 [get_ports {led[2]}]
